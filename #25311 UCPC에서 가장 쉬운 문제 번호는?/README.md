# <img width="20px"  src="https://d2gd6pc034wcta.cloudfront.net/tier/1.svg" class="solvedac-tier"> [UCPC에서 가장 쉬운 문제 번호는?](https://www.acmicpc.net/problem/25311) 

| 제출 번호 | 닉네임 | 채점 결과 | 메모리 | 시간 | 언어 | 코드 길이 |
|---|---|---|---|---|---|---|
|61067251|dong_hyeon|맞았습니다!! |5372KB|64ms|C#|189B|

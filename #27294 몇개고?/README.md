# <img width="20px"  src="https://d2gd6pc034wcta.cloudfront.net/tier/1.svg" class="solvedac-tier"> [몇개고?](https://www.acmicpc.net/problem/27294) 

| 제출 번호 | 닉네임 | 채점 결과 | 메모리 | 시간 | 언어 | 코드 길이 |
|---|---|---|---|---|---|---|
|61067971|dong_hyeon|맞았습니다!! |5496KB|60ms|C#|457B|

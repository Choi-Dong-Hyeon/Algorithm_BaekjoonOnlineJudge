# <img width="20px"  src="https://d2gd6pc034wcta.cloudfront.net/tier/2.svg" class="solvedac-tier"> [치킨댄스를 추는 곰곰이를 본 임스](https://www.acmicpc.net/problem/25191) 

| 제출 번호 | 닉네임 | 채점 결과 | 메모리 | 시간 | 언어 | 코드 길이 |
|---|---|---|---|---|---|---|
|62690235|dong_hyeon|맞았습니다!! |5504KB|88ms|C#|432B|

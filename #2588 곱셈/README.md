# <img width="20px"  src="https://d2gd6pc034wcta.cloudfront.net/tier/3.svg" class="solvedac-tier"> [곱셈](https://www.acmicpc.net/problem/2588) 

| 제출 번호 | 닉네임 | 채점 결과 | 메모리 | 시간 | 언어 | 코드 길이 |
|---|---|---|---|---|---|---|
|59765421|dong_hyeon|맞았습니다!! |5488KB|72ms|C#|544B|
